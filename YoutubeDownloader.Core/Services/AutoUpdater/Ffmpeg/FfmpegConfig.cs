...
public sealed record FfmpegConfig(IDirectory Folder, Uri Uri, string FfmpegExeName = FfmpegConfig.FfmpegName)
{
    ...
    public static Uri SourceUri { get; } = new Uri(Source, UriKind.Absolute);
